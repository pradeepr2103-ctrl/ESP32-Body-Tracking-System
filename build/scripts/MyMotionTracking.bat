...
set CLASSPATH=%APP_HOME%\lib\MyMotionTracking.jar;%APP_HOME%\lib\core.jar;%APP_HOME%\lib\solarxr-protocol.jar;%APP_HOME%\lib\kotlin-reflect-2.0.20.jar;%APP_HOME%\lib\kotlinx-serialization-core-jvm-1.7.1.jar;%APP_HOME%\lib\kotlinx-serialization-json-jvm-1.7.1.jar;%APP_HOME%\lib\kache-jvm.jar;%APP_HOME%\lib\kotlinx-coroutines-core-jvm-1.8.1.jar;%APP_HOME%\lib\kotlin-stdlib-2.0.20.jar;%APP_HOME%\lib\annotations-23.0.0.jar;%APP_HOME%\lib\flatbuffers-java-22.10.26.jar;%APP_HOME%\lib\commons-cli-1.11.0.jar;%APP_HOME%\lib\jackson-core-2.21.0.jar;%APP_HOME%\lib\jackson-dataformat-yaml-2.21.0.jar;%APP_HOME%\lib\jackson-module-model-versioning-1.2.2.jar;%APP_HOME%\lib\jackson-databind-2.21.0.jar;%APP_HOME%\lib\commons-math3-3.6.1.jar;%APP_HOME%\lib\commons-lang3-3.20.0.jar;%APP_HOME%\lib\commons-collections4-4.5.0.jar;%APP_HOME%\lib\Java-WebSocket-1.6.0.jar;%APP_HOME%\lib\jackson-annotations-2.21.jar;%APP_HOME%\lib\snakeyaml-2.4.jar;%APP_HOME%\lib\slf4j-api-2.0.13.jar
